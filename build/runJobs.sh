...
sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 20"
sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 21"
sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 22"
sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 23"
# sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 24"
# sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 25"
# sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 26"
# sbatch --dependency=afterok:$compile_job_id --job-name=myjob --nodes=1 --ntasks=1 --cpus-per-task=64 --mem=250G --time=024:00:00 --partition=calea --wrap="srun -n 1 env OMP_PLACES=threads env OMP_PROC_BIND=true ./main.out 27"
