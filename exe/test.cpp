...
void InterpolationBenchmark()
{
    ...
    for(double i=0.5; i<nx - 1; i++)
    {
        ...
        int i0 = floor(i); int i1 = ceil(i);
        int j0 = floor(j); int j1 = ceil(j);
        int k0 = floor(k); int k1 = ceil(k);
        Tensor4x4 tetrad0_000 = tetrads0[grid.Index(i0,j0,k0)]; Tensor4x4 tetrad1_000 = tetrads1[grid.Index(i0,j0,k0)];
        Tensor4x4 tetrad0_001 = tetrads0[grid.Index(i0,j0,k1)]; Tensor4x4 tetrad1_001 = tetrads1[grid.Index(i0,j0,k1)];
        Tensor4x4 tetrad0_010 = tetrads0[grid.Index(i0,j1,k0)]; Tensor4x4 tetrad1_010 = tetrads1[grid.Index(i0,j1,k0)];
        Tensor4x4 tetrad0_011 = tetrads0[grid.Index(i0,j1,k1)]; Tensor4x4 tetrad1_011 = tetrads1[grid.Index(i0,j1,k1)];
        Tensor4x4 tetrad0_100 = tetrads0[grid.Index(i1,j0,k0)]; Tensor4x4 tetrad1_100 = tetrads1[grid.Index(i1,j0,k0)];
        Tensor4x4 tetrad0_101 = tetrads0[grid.Index(i1,j0,k1)]; Tensor4x4 tetrad1_101 = tetrads1[grid.Index(i1,j0,k1)];
        Tensor4x4 tetrad0_110 = tetrads0[grid.Index(i1,j1,k0)]; Tensor4x4 tetrad1_110 = tetrads1[grid.Index(i1,j1,k0)];
        Tensor4x4 tetrad0_111 = tetrads0[grid.Index(i1,j1,k1)]; Tensor4x4 tetrad1_111 = tetrads1[grid.Index(i1,j1,k1)];

        Tensor4x4 tetrad2_000 = tetrads2[grid.Index(i0,j0,k0)]; Tensor4x4 tetrad3_000 = tetrads3[grid.Index(i0,j0,k0)];
        Tensor4x4 tetrad2_001 = tetrads2[grid.Index(i0,j0,k1)]; Tensor4x4 tetrad3_001 = tetrads3[grid.Index(i0,j0,k1)];
        Tensor4x4 tetrad2_010 = tetrads2[grid.Index(i0,j1,k0)]; Tensor4x4 tetrad3_010 = tetrads3[grid.Index(i0,j1,k0)];
        Tensor4x4 tetrad2_011 = tetrads2[grid.Index(i0,j1,k1)]; Tensor4x4 tetrad3_011 = tetrads3[grid.Index(i0,j1,k1)];
        Tensor4x4 tetrad2_100 = tetrads2[grid.Index(i1,j0,k0)]; Tensor4x4 tetrad3_100 = tetrads3[grid.Index(i1,j0,k0)];
        Tensor4x4 tetrad2_101 = tetrads2[grid.Index(i1,j0,k1)]; Tensor4x4 tetrad3_101 = tetrads3[grid.Index(i1,j0,k1)];
        Tensor4x4 tetrad2_110 = tetrads2[grid.Index(i1,j1,k0)]; Tensor4x4 tetrad3_110 = tetrads3[grid.Index(i1,j1,k0)];
        Tensor4x4 tetrad2_111 = tetrads2[grid.Index(i1,j1,k1)]; Tensor4x4 tetrad3_111 = tetrads3[grid.Index(i1,j1,k1)];
