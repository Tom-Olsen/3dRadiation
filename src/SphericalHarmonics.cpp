...
{ return 0.50 * sqrt(15.0 / M_PI) * x * y; }
double SphericalHarmonics::Y2m1(double x, double y, double z)
{ return 0.50 * sqrt(15.0 / M_PI) * y * z; }
...
{ return 0.50 * sqrt(15.0 / M_PI) * z * x; }
...
{ return 0.50 * sqrt(105.0 / M_PI) * x * y * z; }
...
{ return 0.7500 * sqrt(35.0 / M_PI) * (x * x - y * y) * x * y; }
double SphericalHarmonics::Y4m3(double x, double y, double z)
{ return 0.7500 * sqrt(35.0 / (2.0 * M_PI)) * (3.0 * x * x - y * y) * y * z; }
double SphericalHarmonics::Y4m2(double x, double y, double z)
{ return 0.7500 * sqrt(5.0 / M_PI) * (7.0 * z * z - 1.0) * x * y; }
double SphericalHarmonics::Y4m1(double x, double y, double z)
{ return 0.7500 * sqrt(5.0 / (2.0 * M_PI)) * (7.0 * z * z - 3.0) * y * z; }
...
{ return 0.7500 * sqrt(5.0 / (2.0 * M_PI)) * (7.0 * z * z - 3.0) * x * z; }
double SphericalHarmonics::Y4p2(double x, double y, double z)
{ return 0.3750 * sqrt(5.0 / M_PI) * (x * x - y * y) * (7.0 * z * z - 1.0); }
double SphericalHarmonics::Y4p3(double x, double y, double z)
{ return 0.7500 * sqrt(35.0 / (2.0 * M_PI)) * (x * x - 3.0 * y * y) * x * z; }
