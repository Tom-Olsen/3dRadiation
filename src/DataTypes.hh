...
public:
    ...
    {
        return Tensor3(a[2] * b[3] - b[2] * a[3],
                       a[3] * b[1] - b[3] * a[1],
                       a[1] * b[2] - b[1] * a[2]);
    }
...
public:
    ...
    {
        return Tensor4(data[0] / scalar, data[1] / scalar, data[2] / scalar, data[3] / scalar);
    }
    Tensor4 operator*(double scalar) const
    {
        return Tensor4(data[0] * scalar, data[1] * scalar, data[2] * scalar, data[3] * scalar);
    ...
    {
        return Tensor4((*this)[0] + other[0], (*this)[1] + other[1], (*this)[2] + other[2], (*this)[3] + other[3]);
    }
    Tensor4 operator-(const Tensor4 &other) const
    {
        return Tensor4((*this)[0] - other[0], (*this)[1] - other[1], (*this)[2] - other[2], (*this)[3] - other[3]);
...
public:
    ...
    Tensor3x3x3(double xxx, double xxy, double xxz,
...
public:
    ...
    Tensor4x4x4(double ttt, double ttx, double tty, double ttz,
...
public:
    ...
    const std::span<const T> operator[](const int index) const
    {
        size_t start = m_indexes[index];
        size_t end = m_indexes[index + 1];
